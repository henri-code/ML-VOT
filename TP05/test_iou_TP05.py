...
resnet_model.eval()  # Mettre le modèle en mode évaluation
updated_tracks = iou.track_management_with_hungarian_and_kalman_filter_and_ia(tracks, loaded_detections, similarity_matrix, resnet_model)
...
print("Start writing")
sequence_name = "TP05"
iou.save_tracking_results(updated_tracks, sequence_name)
